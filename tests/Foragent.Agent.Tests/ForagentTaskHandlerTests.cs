...
public class ForagentTaskHandlerTests
{
    ...
    public async Task DispatchesToMatchingCapability()
    {
        ...
        var handler = new ForagentTaskHandler([alpha, beta], NullLogger<ForagentTaskHandler>.Instance);
    ...
    public async Task PublishesWorkingStatus_BeforeDispatch()
    {
        ...
        var handler = new ForagentTaskHandler([alpha], NullLogger<ForagentTaskHandler>.Instance);
